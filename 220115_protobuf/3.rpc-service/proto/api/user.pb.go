...
func (x *UserData) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *UserData) GetHobby() []string {
	if x != nil {
		return x.Hobby
	}
	return nil
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x77, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x44,
	...
	0x65, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x6f,
	0x62, 0x62, 0x79, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x68, 0x6f, 0x62, 0x62, 0x79,
